...
let filterData1 = document.getElementById("btn-1");
let filterData2 = document.getElementById("btn-3");
let filterData3 = document.getElementById("btn-4");
...
function openSeeMoreWindow(somedata) {
            const newWindow = window.open("", "_practice", "width=300,height=300");
